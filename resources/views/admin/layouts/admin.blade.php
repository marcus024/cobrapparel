...
<body class="bg-gray-100">
    ...
    <aside class="w-64 bg-[#700101] text-white p-5 fixed h-screen">
        ...
        <ul>
            <li class="mb-3"><a href="{{ route('admin.dashboard') }}" class="block p-2">Dashboard</a></li>
            <li class="mb-3"><a href="{{ route('admin.shops') }}" class="block p-2">Shops</a></li>
            <li class="mb-3"><a href="{{ route('admin.products') }}" class="block p-2">Products</a></li>
            <li class="mb-3"><a href="{{ route('admin.orders') }}" class="block p-2">Orders</a></li>
            <li class="mb-3"><a href="{{ route('admin.export') }}" class="block p-2">Export</a></li>
            <li>
