...
<div class="container text-center">
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="links">
                ...
                <a href="https://www.rossedlin.com/portfolio/stripe-laravel/code" target="_blank">BitBucket (Source
                    Code)</a>
            </div>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-12">
            <img src="https://assets.edlin.app/logo/logo-symbol-dark.png" height='100' alt="Ross Edlin Logo"/>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\cobrapparel\resources\views/layout.blade.php ENDPATH**/ ?>