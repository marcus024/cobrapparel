                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-300 p-2"><?php echo e($shopName); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->first_name); ?> <?php echo e($order->last_name); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->email); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->phone); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->address); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->city); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->state); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->postcode); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->status); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($order->reference_code); ?></td>
                            
                             <!-- Shop Name Column -->
                            <td class="border border-gray-300 p-2"><?php echo e($item->product_name); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($item->quantity); ?></td>
                            <td class="border border-gray-300 p-2">$<?php echo e($item->price); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($item->size ?? 'N/A'); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($item->custom_name ?? 'N/A'); ?></td>
                            <td class="border border-gray-300 p-2"><?php echo e($item->custom_number ?? 'N/A'); ?></td>
                            <td class="border border-gray-300 p-2">
                                <button onclick="openModal('<?php echo e($order->order_id); ?>')" class="bg-blue-500 text-white px-2 py-1 rounded">View</button>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\cobrapparel\resources\views/admin/orders.blade.php ENDPATH**/ ?>